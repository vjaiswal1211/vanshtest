...
//	static Logger log = java.util.logging.Logger.getLogger(SearchPage.class);
	...
	public static void navigateToFlightsTab(WebDriver driver) {
		...
		element = driver.findElement(By.xpath("//span[contains(@class,'uitk-tab-text') and contains(text(),'Flights')]"));
		element.click();
